 ...
 * @author user
 */
public class tch_view_salary extends javax.swing.JFrame {
    Connection con;

    /**
     * Creates new form tch_view_salary
     */
    public tch_view_salary() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tbl_tchsalary = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Teacher's Salary View");
        setResizable(false);
        ...
        jLabel2.setText("TEACHER SALARY INFORMATION");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/Teacher-icon.png"))); // NOI18N
        ...
        tbl_tchsalary.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Name", "Mobile No", "Date", "Salary", "Month"
            }
        ) {
        ...
        jScrollPane1.setViewportView(tbl_tchsalary);
    ...
    private void btn_viewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_viewActionPerformed
        ...
        try{
            ...
            DefaultTableModel model = (DefaultTableModel) tbl_tchsalary.getModel();
            while(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tch_view_salary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tbl_tchsalary;
